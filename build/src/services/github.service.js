...
var GithubService = /** @class */ (function () {
    function GithubService(configService) {
        this.configService = configService;
        this.graphql = graphql_1.graphql.defaults({
            headers: {
                authorization: "token ".concat(this.configService.config.GITHUB_TOKEN),
                'user-agent': this.configService.config.APP_NAME
            }
        });
    }
    GithubService.prototype.readme = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.graphql("\n    query readme {\n      repository(owner: \"dominicegginton\", name: \"dominicegginton\") {\n        object(expression: \"HEAD:README.md\") {\n          ... on Blob {\n            text\n          }\n        }\n      }\n    }\n  ")];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.repository.object];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.viewer.repositories.nodes];
                }
            });
        });
    };
